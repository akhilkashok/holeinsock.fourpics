...
var int1='#EBFF05';  
//
var almost=['כמעט..','נסה שוב','מתקרב..','כמעט שם','קרוב..','דומה..'];
var incorrect=['אמםם.. לא',' רחוק','לא בכיוון','לא כל כך','נסה שוב','לא להתייאש','?רמז אולי'];
...
dataCache.frames=new Array(his.e('levelsFrame'),his.e('gameFrame'),his.e('thumbsFrame'),his.e('menuFrame'),his.e('achievementsFrame'));
}
...
this.items=new Array("- הדיסק און הראשון נוצר על ידי חברת M-systems הישראלית ברשות דב מור!",
...
this.updateSplash=function(){  
									...
									splash.textContent=this.items[ parseInt(r)];
